...
<img src="/assets/gamejam-1.\jpg" style="float: right; max-width: 350px" /> And we were back to kick some ass and chew bubblegum.
...
<img src="/assets/gamejam-2.png" style="float: left; max-width: 350px" /> So we decided that the carrier pigeon would be a playable character in a World War 1 themed game and got rolling on the darkly themed narrative which would be aptly named “Courier”.
